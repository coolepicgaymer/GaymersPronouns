...
public final class GaymersPronouns extends JavaPlugin {
    ...
    public void reload() {
        ...
        PronounsMenu.reload(getConfig().getBoolean("show-tutorial-item"), getConfig().getBoolean("log-pronoun-changes"), getConfig().getBoolean("use-individual-colors"), getConfig().getConfigurationSection("gui"), getLogger());
    }
