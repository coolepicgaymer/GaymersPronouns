...
public final class GaymersPronouns extends JavaPlugin {
    ...
    public void reload() {
        ...
        PronounsMenu.reload(getConfig().getBoolean("show-tutorial-item"), getConfig().getBoolean("log-pronoun-changes"), getConfig().getBoolean("use-individual-colors"), getConfig().getString("gui.items.group1", "NAME_TAG"), getConfig().getString("gui.items.group2", "RABBIT_FOOT"), getConfig().getString("gui.items.selected", "EMERALD_BLOCK"), getLogger());
    }
